...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, readBody, createError, getQuery as getQuery$1, getResponseStatusText } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/devalue/index.js';
import { renderToString } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/scule/dist/index.mjs';
import { klona } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\ethandunford\\WebstormProjects\\tanstack-query-nuxt-3","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\ethandunford\\WebstormProjects\\tanstack-query-nuxt-3\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\ethandunford\\WebstormProjects\\tanstack-query-nuxt-3\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\ethandunford\\WebstormProjects\\tanstack-query-nuxt-3\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\ethandunford\\WebstormProjects\\tanstack-query-nuxt-3\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _gRYXPn3WsN = (function(nitro) {
...
const _lazy_JiGprW = () => Promise.resolve().then(function () { return getTimeStamp$1; });
const _lazy_cAPz5R = () => Promise.resolve().then(function () { return isEven$1; });
const _lazy_9w8XQ8 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/get-time-stamp', handler: _lazy_JiGprW, lazy: true, middleware: false, method: undefined },
  { route: '/api/is-even', handler: _lazy_cAPz5R, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_9w8XQ8, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_9w8XQ8, lazy: true, middleware: false, method: undefined }
];
...
const getTimeStamp = defineEventHandler((event) => {
  return {
    date: /* @__PURE__ */ new Date()
  };
});

const getTimeStamp$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: getTimeStamp
});

const isEven = defineEventHandler(async (event) => {
...
const isEven$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: isEven
});
...
const getClientManifest = () => import('file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/ethandunford/WebstormProjects/tanstack-query-nuxt-3/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
